import { BiLogoNodejs, BiLogoReact, BiLogoTypescript, BiLogoCss3, BiLogoJavascript, BiLogoTailwindCss, BiLogoPostgresql, BiLogoDocker, BiLogoHtml5 } from "react-icons/bi";
...
export function ProjectsList() {
  const skills = {
    ...
    "context-api": { name: "Context API", icon: <BiLogoReact size={20} /> },
    "html": { name: "HTML", icon: <BiLogoHtml5 size={20} /> },
    ...
    "react-hooks": { name: "React Hooks", icon: <BiLogoReact size={20} /> },
  ...
  return (
    <div className="flex flex-wrap items-center m-auto">
      ...
      <ProjectCard
        title="Recipes App"
        image="/projects/app-receitas-mockup.png"
        description="App to search for recipes and save them to your favorites."
        skills={[skills.react, skills.html, skills.css, skills["context-api"], skills["react-hooks"]]}
        link="https://cleytonoliveira.github.io/recipes-app/"
      />
    </div>
  );
}